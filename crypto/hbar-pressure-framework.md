---
title: "HBAR Inflation Analysis · July 2026 · Supply growing, projected to keep growing"
description: "A MrNasdog Pressure Framework read of Hedera (HBAR): 50B hard cap, no mint, no fee burn — 418M of Council reserve release reached the float in 90 days. Net +0.95%, monitor +0.95%."
...
Hedera created all **50 billion HBAR** at launch and has no way to make more, so HBAR inflation is not emission — it is the Hedera Governing Council moving already-minted HBAR out of reserve. Over the 90 days to **Jul 27 2026** the tradable float grew **418M HBAR**, in two discrete Council release lots, while nothing at all removed supply: Hedera runs no buyback and burns no fees. The Pressure Framework reads **+0.95% net** against a supply monitor at **+0.95%** — a gap of **0.00 percentage points**, the cleanest kind of read.

## The verdict, in one paragraph

For the 90-day window ending **Jul 27 2026**, the MrNasdog Pressure Framework reads HBAR at **+0.95% net** supply growth, and projects the same **+0.95%** forward. Total sell pressure was **418M HBAR**; total buy pressure was **zero**. Our supply monitor reads the same window at **+0.95%**, leaving a gap of about **0.00 percentage points** — far inside the half-point tolerance, so no monitor-gap chip ships on the HBAR overview. The reason the two agree so precisely is unusual and worth naming: on Hedera, the number the wider market calls circulating supply is a value the network itself publishes, so the framework and the monitor are reading the same on-chain quantity rather than two competing classifications. The cite-able label for HBAR is a **fixed-ceiling chain releasing reserve onto the float in lumps** — mildly inflationary today, with a hard limit on how much inflation is left.
...
All of HBAR's real supply growth therefore lands in Sell #3, Foundation and unscheduled unlocks, at **418M HBAR** over the window. Reading the network's own supply record at both ends of the window gives **43,373M HBAR** on **Apr 28 2026** and **43,791M HBAR** on **Jul 27 2026**. The shape of that growth matters more than the total: it is a staircase, not a slope. The float was flat for six straight weeks, took a **100M HBAR** Council release on **Jun 16 2026**, sat flat again, then took roughly **317M HBAR** across **Jul 1 2026** to **Jul 3 2026**, including one clean **150M HBAR** lot. Anyone modelling HBAR unlocks as a smooth monthly drip is modelling the wrong mechanism.

Sell #4, long-term locked or bankruptcy, is **zero**. No bankruptcy estate or court-ordered distribution holds HBAR, so there is no trustee release schedule to track. We also carry a fifth row for the staking reward pool, currently valued at **zero**: that pool fell from **200.8M** to **176.3M HBAR** across the window, but because it already sits inside the float, its payouts add no supply. It is a watch item rather than a live row — at this drain rate the pool has roughly seven quarters left, and a top-up from reserve would be genuine new float.
...
There is one trap here worth spelling out, because it produces alarming headlines. Hedera's own treasury report counts HBAR as released the moment it leaves a Council-controlled account for another party — usually a Foundation — which puts its released figure near **95%** of the cap. The tradable float is a narrower, lower number, and the two can diverge by billions. The published guidance is measured on the wider definition and consistently overshoots what actually reaches the market: guidance of about **4B HBAR** for the Apr to Jun 2026 quarter produced **186M** of real float, and guidance for Jul to Sep 2026 again sits near **4B**. The framework books only the float, re-reads the reserve on every rebuild, and treats the guidance as a ceiling rather than a forecast. If reserve or Foundation balances fall between refreshes, that outflow enters Sell #3 at the next refresh.
