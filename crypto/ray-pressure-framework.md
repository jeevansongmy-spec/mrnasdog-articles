...
description: "Supply shrinking: Raydium releases ~0.51M RAY/90d while a 12%-of-fees buyback holds 2.39M off market. Framework −0.70% net vs a +0.25% monitor read, so a gap chip ships."
...
Raydium releases about **0.51M RAY** over 90 days from a fixed mining reserve, while the buyback funded by **12%** of every pool's trading fee took **2.39M RAY** off the open market and held it. RAY minting is permanently disabled, so the buyback outpaces the emission and the Pressure Framework reads **−0.70% net** on the active float. Our supply monitor reads **+0.25%** because it still counts the held buyback wallet as circulating — a **0.94-point** gap that is mechanical, not an error.

## The verdict, in one paragraph

For the 90-day window ending **Jul 30 2026**, the MrNasdog Pressure Framework reads **RAY at −0.70% net**: **0.51M RAY** of sell pressure against **2.39M RAY** of buy pressure on a circulating base of **269.31M RAY**. Our supply monitor reads the realised change over the same 90 days at **+0.25%**, a gap of **0.94 percentage points**. That exceeds the framework's half-point tolerance, so a **monitor-gap chip ships** on the RAY overview. The gap resolves cleanly: the Raydium buyback does not burn RAY, it accumulates it in a public wallet that the monitor's upstream classification still treats as circulating supply. The **2.39M RAY** absorbed is worth **0.89 points** of the gap on its own, and the small difference between the framework's emission read and the monitor's realised float growth covers the remaining **0.06 points**. RAY is best read as **structurally deflationary on the active float**, with the held buyback stack sitting behind it as a governance-reversible overhang.
...
Buy #1, the programmatic buyback, carries the whole buy side at **2.39M RAY** over 90 days. Raydium routes **12%** of every pool's trading fee into automatic open-market RAY purchases — the same share on concentrated-liquidity pools, constant-product pools and legacy AMM v4 pools, applied to the trading fee rather than to the trade size. This build measured the row the hard way: the Raydium buyback accumulation wallet held **81.07M RAY** on **Apr 30 2026** and **83.46M RAY** on **Jul 30 2026**, a clean **2.39M RAY** of accumulation with no outflow. The recent 30-day pace confirms it has not collapsed: the wallet added **0.82M RAY** in the last month alone, because a lower RAY price buys more RAY per dollar of fees even as those fees shrink.

Buy #2, protocol fee burn, is **zero**, and this is the single most misread fact about RAY. Raydium does not burn its buyback. Bought-back RAY is transferred to a public accumulation wallet and held there; RAY total supply has not moved, which proves nothing was destroyed. Several secondary articles claim Raydium sends acquired RAY to a burn address — that is false, contradicted by both the official documentation and the on-chain state. Buy #3, foundation buy, is **zero** — Raydium does no discretionary open-market buying outside the automatic fee buyback. Buy #4, new long-term lock, is **zero** as well: RAY staking is user-initiated and withdrawable at any time, so it locks nothing structurally, and no new escrow or multi-year lock was announced in the window.
...
The sixth and most consequential overhang is the buyback wallet itself, now **83.5M RAY** — about **31%** of circulating RAY, bought with well over **$200M** of cumulative Raydium protocol fees. Because Raydium holds rather than burns, that stack is a real, reversible supply overhang: a future governance decision could redeploy it, sell it, or burn it, and only one of those three outcomes is good for holders. It is tracked on-chain daily. If the buyback wallet's balance falls between refreshes, that outflow enters Sell #3 at the next refresh. The same trigger applies to each of the five Raydium allocation wallets.
